...
<head>
	...
	<script type="text/javascript">
		$(function () {
			...
			$("#contactsId").val("${task.contactsId}");
			$("#taskStage").val("${task.taskStage}");
			alert("${task.taskStage}"+"${contacts.fullname}"+"${task.contactsId}");
			$("#priority").val("${task.priority}");
			$("#description").val("${task.description}");
			$("#repeatType").val("${task.repeatType}");
			$("#noticeType").val("${task.noticeType}");
			$("#contacts").val("${contacts.fullname}");
...
<div style="position:  relative; left: 30px;">
	...
	<div style="position: relative; top: -40px; left: 70%;">
		<button type="button" id="saveTask" class="btn btn-primary">更新</button>
		<button type="button"  class="btn btn-default">取消</button>
	</div>
	<hr style="position: relative; top: -40px;">
</div>
<form class="form-horizontal" method="get" action="workbench/task/editTask.do" id="taskForm" role="form">
